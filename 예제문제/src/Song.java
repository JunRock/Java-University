...
class Song1{
    ...
    public Song1(String num,String title,String name,String publi){
        this.num=num;
        this.title=title;
        this.name=name;
        this.publi=publi;
...
class Song{
    public static void main(String[] args){
        ...
        ArrayList<Song1> list=new ArrayList<>();
        loop:
        while(true){
        ...
        case 1: System.out.print("도서번호: ");
                ...
                Song1 book=new Song1(num,title,name,publi);
                list.add(book);
                break;
        ...
        case 4: System.out.print("수정하고싶은 책의 도서 번호를 입력하세요: ");
                ...
                for(int i=0; i<list.size(); i++){
                    ...
                    if(bookNum3.equals(num3)){
                        ...
                        Song1 b4=list.set(i,new Song1(setNum,setTitle,setName,setPubli));
                    }
                }
                break;
        case 5: Iterator<Song1> it=list.iterator();
                while(it.hasNext()){
                    Song1 result=it.next();
                    result.print();
                    System.out.println();
                }
                break;
